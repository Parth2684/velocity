...
use std::{collections::HashMap, ffi::OsString, fs, net::{SocketAddr, UdpSocket}, sync::Mutex};
...
pub fn run() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            let local_data_dir = app.path().local_data_dir().expect("local data dir not created");
